...
public class History extends javax.swing.JDialog {
    ...
    private void customOperations() {
        ...
        try{
            ...
            for (int i = 0; i < operations.size(); i++) {
                ...
                // Amount
                row[1] = operation.getAmount();

                // Date
                row[2] = dateFormat.format(operation.getDate());
    ...
    private void initComponents() {
        ...
        setTitle(Session.getBank().getName() + " - History");
        ...
        panelbTitle.setText("Transactions History");
        ...
        String header[] = new String[] { "Type", "Amount", "Date" };

        // add header in table model
        dtm.setColumnIdentifiers(header);

        //set model into the table object
        tableDeposits.setModel(dtm);
