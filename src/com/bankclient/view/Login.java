...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblAccount1.setText("Account no.:");
        ...
        setTitle("Online Banking Portal - Log in");
        setResizable(false);
        ...
        panelbTitle.setText("Online Banking Portal");
    ...
    private void onClickLogin() {
        ...
        try {
            ...
            if (customer != null){
                Session.setAccountNumber(customer.getAccountNumber());
                Session.setName(customer.getName());
                Session.setBank(customer.getBank());
